...
- On Windows： Pre-built [binary](https://github.com/VisionAdvanceTechnologyInc/vatek_sdk_2/releases/download/v3.00/VATek-Win64-3.00.exe) is available.
- On Linux： (Ubuntu) provides open source. 
